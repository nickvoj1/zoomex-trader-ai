...
function rowToHistoricalMicrostructure(row: MicrostructureHistoryRow): HistoricalMicrostructureSnapshot | null {
  ...
  return {
    ...
    microstructure: (rawMicrostructure as ReturnType<typeof buildMarketMicrostructure>) ?? buildMarketMicrostructure({
      ...
      tradeCount1m: safeNumber((row as unknown as Record<string, unknown>).trade_count_1m),
      tradeNotionalUsd1m: safeNumber((row as unknown as Record<string, unknown>).trade_notional_usd_1m),
      aggressiveBuyNotionalUsd1m: safeNumber((row as unknown as Record<string, unknown>).aggressive_buy_notional_usd_1m),
      aggressiveSellNotionalUsd1m: safeNumber((row as unknown as Record<string, unknown>).aggressive_sell_notional_usd_1m),
      aggressiveFlowImbalance1m: safeNumber((row as unknown as Record<string, unknown>).aggressive_flow_imbalance_1m),
    }),
    source: "supabase",
  };
}
