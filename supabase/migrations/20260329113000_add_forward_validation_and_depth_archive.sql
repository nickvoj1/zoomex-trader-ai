...
create policy if not exists "Authenticated users can read orderbook snapshots"
...
create policy if not exists "Authenticated users can read trade ticks"
...
create policy if not exists "Users can read own forward validation reports"
